...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(/static/images/weather/clouds.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(/static/images/weather/rainy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(/static/images/weather/clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(/static/images/weather/snow.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(/static/images/weather/sunny.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(/static/images/weather/thunderstrom.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(/static/images/weather/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(/static/images/weather/mist.jpg)';
    }
